...
class AttendeesControllerTest < ActionController::TestCase
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post :create, attendee: { email: @attendee.email, event_id: @attendee.event_id, name: @attendee.name, phone: @attendee.phone, school_id: @attendee.school_id }
    end
  ...
  test "should update attendee" do
    patch :update, id: @attendee, attendee: { email: @attendee.email, event_id: @attendee.event_id, name: @attendee.name, phone: @attendee.phone, school_id: @attendee.school_id }
    assert_redirected_to attendee_path(assigns(:attendee))
  end
